...
import 'package:riverpod_example_project/views/07_5_streamProviderCNPView/c_cnp_currentTicketState.dart';

class StreamProviderCNPView extends ConsumerWidget {
  ...
  /// of a view.
  const StreamProviderCNPView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final stateNotifier = ref.watch(currentTicketViewModel);
