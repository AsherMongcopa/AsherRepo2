...
import 'package:riverpod_example_project/views/07_5_streamProviderCNPView/c_fp_getTickets.dart';
import 'package:riverpod_example_project/views/07_5_streamProviderCNPView/ma_commentsModel.dart';
import 'package:riverpod_example_project/views/07_5_streamProviderCNPView/ma_ticketModel.dart';
...
// the other providers.
final currentTicketViewModel = ChangeNotifierProvider.autoDispose((ref) {
  print('currentTicketViewModel run');

  ref.onDispose(() {
    print('currentTicketViewModel dispose');
  });

  List<TicketModel> ticketList = ref.watch(getTickets).when(
  ...
  return CurrentTicketController(
      TicketsCommentsListModel(ticketList: ticketList, currentTicketId: ''),
      ref);
});

class CurrentTicketController extends ChangeNotifier {
  ...
  TicketsCommentsListModel state;
